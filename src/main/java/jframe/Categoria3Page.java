 ...
 * @author alexa
 */
public class Categoria3Page extends javax.swing.JFrame {
    ...
    /**
     * Creates new form Categoria3Page
     * @param jogo
     * @param jogador
     */
    public Categoria3Page(JogoPage jogo, jutil.Jogador jogador) {
        ...
        try (Connection con = conector.getConnection();) {
            ...
            while(idLinha.next()){
                ...
                if (!jogador.getPerguntas3().contains(id)){
                    listID.add(id);
                }
            }
            ...
            jogador.AddPerguntas3(elementId);
    ...
    private void initComponents() {
        ...
        Categoria3Fundo = new javax.swing.JLabel();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        SeguinteBotao.setBackground(new java.awt.Color(204, 102, 255));
        SeguinteBotao.setFont(new java.awt.Font("Times New Roman", 0, 24)); // NOI18N
        SeguinteBotao.setForeground(new java.awt.Color(153, 0, 153));
        ...
        titulo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/funcaoComandoTitulo.jpg"))); // NOI18N
        getContentPane().add(titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 0, -1, -1));

        enunciado.setEditable(false);
        enunciado.setBackground(new java.awt.Color(221, 197, 233));
    ...
    private void alternativaDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_alternativaDActionPerformed
        ...
        alternativaD.setBackground(new Color(204,153,255));
    ...
    private void alternativaAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_alternativaAActionPerformed
        // TODO add your handling code here:
        selecionada = 1;
        alternativaA.setBackground(new Color(204,153,255));
        alternativaB.setBackground(Color.lightGray);
        alternativaC.setBackground(Color.lightGray);
    ...
    private void alternativaBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_alternativaBActionPerformed
        ...
        selecionada = 2;
        alternativaA.setBackground(Color.lightGray);
        alternativaB.setBackground(new Color(204,153,255));
        alternativaC.setBackground(Color.lightGray);
        alternativaD.setBackground(Color.lightGray);
    ...
    private void alternativaCActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_alternativaCActionPerformed
        ...
        alternativaA.setBackground(Color.lightGray);
        alternativaB.setBackground(Color.lightGray);
        alternativaC.setBackground(new Color(204,153,255));
        alternativaD.setBackground(Color.lightGray);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Categoria3Page.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Categoria3Page(jogo, jogador ).setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JLabel Categoria3Fundo;
