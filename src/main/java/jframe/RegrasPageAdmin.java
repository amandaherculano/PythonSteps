 ...
 * @author alexa
 */
public class RegrasPageAdmin extends javax.swing.JFrame {

    /**
     * Creates new form regrasPage
     */
    public RegrasPageAdmin() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegrasPageAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegrasPageAdmin().setVisible(true);
            }
        });
    }
