 ...
 * @author alexa
 */
public class ComecarAdminPage extends javax.swing.JFrame {

    /**
     * Creates new form ComecarPage
     */
    public ComecarAdminPage() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ComecarAdminPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ComecarAdminPage().setVisible(true);
            }
        });
    }
